...
mod tests {
    ...
    fn test_to_starknet_transaction() {
        ...
        let transaction = TransactionSigned::from_transaction_and_signature(Transaction::Eip2930(TxEip2930 { chain_id: 1_802_203_764, nonce: 33, gas_price:  0, gas_limit: 302_606, to: TxKind::Create, value: U256::ZERO, access_list: Default::default(), input: bytes!("") }), Signature { r: U256::from_str("0x6290c177b6ee7b16d87909474a792d9ac022385505161e91191c57d666b61496").unwrap(), s: U256::from_str("0x7ba95168843acb8b888de596c28033c6c66a9cb6c7621cfc996bc5851115634d").unwrap(), odd_y_parity: true });

        // Invoke the function to convert the transaction to Starknet format.
        if let BroadcastedInvokeTransaction::V1(tx) =
            to_starknet_transaction(&transaction, address!("0xf39Fd6e51aad88F6F4ce6aB8827279cffFb92266"), 0).unwrap()
        {
