#![allow(non_snake_case, missing_docs, clippy::derive_partial_eq_without_eq)]

/// Module containing bindings for the KakarotCore contract.
...
lazy_static! {
    /// Field element representing the Starknet native token.
