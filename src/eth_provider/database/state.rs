...
/// Cache database type for the Ethereum database.
pub(crate) type EthCacheDatabase<P> = CacheDB<EthDatabase<P>>;

/// Ethereum database type.
#[derive(Debug)]
#[allow(clippy::redundant_pub_crate)]
pub(crate) struct EthDatabase<P: EthereumProvider + Send + Sync> {
