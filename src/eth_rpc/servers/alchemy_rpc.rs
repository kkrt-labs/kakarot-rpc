...
impl<P: EthereumProvider + Send + Sync + 'static> AlchemyApiServer for AlchemyRpc<P> {
    ...
    #[tracing::instrument(skip_all, ret, fields(token_address = %token_address))]
    ...
    #[tracing::instrument(skip_all, ret, fields(token_address = %token_address, owner = %owner, spender = %spender))]
