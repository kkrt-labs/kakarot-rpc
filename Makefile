...
run-katana: install-katana
	...
	katana --dump-state --block-time 6000 --disable-fee .katana/dump.bin & echo $$! > .katana/pid
...
# Make sure to have a Kakarot RPC running on port 3030 and an underlying Starknet client running.
